...
(function ($) {
  ...
  $.fn.mediumInsert.registerAddon('heroimages', {
    ...
    */
    ...
    add: function ($placeholder) {
    	console.log("add in insert storu image");
      var that = this,
          $selectFile, files;
    ...
    */
    ...
    uploadCompleted: function (jqxhr, $placeholder,that) {
      ...
      if (jqxhr.responseText) {
    	...
    	$($placeholder).parents('.hero-editable').css("background",'url(' + jqxhr.responseText + ')'); 
    	$($placeholder).parents('.hero-editable').css("background-size","cover");
    	$($placeholder).parents('.hero-editable').css("-webkit-background-size","cover");
